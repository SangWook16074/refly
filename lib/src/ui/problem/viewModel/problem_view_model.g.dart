...
abstract class _$DailyProblemViewModel
    extends BuildlessAsyncNotifier<List<Problem>> {
  late final DateTime target;

  FutureOr<List<Problem>> build({
...
/// See also [DailyProblemViewModel].
class DailyProblemViewModelFamily extends Family<AsyncValue<List<Problem>>> {
  /// See also [DailyProblemViewModel].
...
class DailyProblemViewModelProvider
    extends AsyncNotifierProviderImpl<DailyProblemViewModel, List<Problem>> {
  /// See also [DailyProblemViewModel].
  ...
  @override
  FutureOr<List<Problem>> runNotifierBuild(
  ...
  @override
  AsyncNotifierProviderElement<DailyProblemViewModel, List<Problem>>
      createElement() {
...
mixin DailyProblemViewModelRef on AsyncNotifierProviderRef<List<Problem>> {
  /// The parameter `target` of this provider.
  DateTime get target;
}

class _DailyProblemViewModelProviderElement
    extends AsyncNotifierProviderElement<DailyProblemViewModel, List<Problem>>
    with DailyProblemViewModelRef {
